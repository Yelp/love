...
class TestLoveLink(unittest.TestCase):
    ...
    def test_get_love_link(self):
        ...
        assert link.hash_key == 'HeLLo'
        assert link.recipient_list == 'johndoe,janedoe'
        assert link.message == 'well hello there'

    def test_create_love_link(self):
        link = logic.love_link.create_love_link('jake', "it's adventure time!")
        assert link.recipient_list == 'jake'
        assert link.message == "it's adventure time!"
    ...
    def test_add_recipient(self):
        ...
        assert new_link.recipient_list, 'finn == princessbubblegum'
    ...
    def test_love_links_cleanup(self):
        ...
        assert db_love.hash_key == new_love.hash_key
